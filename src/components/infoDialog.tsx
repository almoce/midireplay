		...
		<Dialog>
			...
			<DialogContent>
				...
				<div className="flex flex-col items-left gap-2 sans">
					<p className="text-sm text-black/30 items-center">
						<a href="https://github.com/almoce/midireplay" className="flex items-center">
							...
							<span className="px-1">Build with: Reat, Tailwind, Radix-ui, Tonejs, Zustand</span></a>
					</p>
					<p className="text-sm text-black/30 flex justify-between">
